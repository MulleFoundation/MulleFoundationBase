...
#
# MulleObjCStandardFoundation-startup url: ${MULLE_OBJC_STANDARD_FOUNDATION__STARTUP_URL:-https://github.com/mulle-kybernetik-tv/MulleObjCStandardFoundation-startup/archive/${MULLE_TAG}.tar.gz}
#
export MULLE_OBJC_STANDARD_FOUNDATION__STARTUP_URL="https://github.com/mulle-kybernetik-tv/MulleObjCStandardFoundation-startup.git"

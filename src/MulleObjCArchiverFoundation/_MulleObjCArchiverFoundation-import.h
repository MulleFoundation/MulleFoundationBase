...
// (Use F92732E2-5F93-4BB7-9267-E2E3F716BC8A instead of MulleObjCStandardFoundation, if there are duplicate entries)
//
...
#ifdef __has_include
# if __has_include( "_MulleObjCArchiverFoundation-include.h")
